...
test "#hue", ->
  ...
  equalEnough color2.r, 84
  equalEnough color2.g, 37
  equalEnough color2.b, 239
  equalEnough color2.a, 1.0
...
test "#complement", ->
  ...
  equalEnough color2.r, 51
  equalEnough color2.g, 31
  equalEnough color2.b, 10
  equalEnough color2.a, 1.0
...
test "#grayscale", ->
  ...
  equalEnough color2.r, 35
  equalEnough color2.g, 35
  equalEnough color2.b, 35
  equalEnough color2.a, 1.0
...
test "#saturate", ->
  ...
  equalEnough color2.r, 69
  equalEnough color2.g, 232
  equalEnough color2.b, 150
  equalEnough color2.a, 1.0
...
test "#desaturate", ->
  ...
  equalEnough color2.r, 100
  equalEnough color2.g, 200
  equalEnough color2.b, 150
  equalEnough color2.a, 1.0
...
test "#darken", ->
  ...
  equalEnough color2.r, 22
  equalEnough color2.g, 32
  equalEnough color2.b, 19
  equalEnough color2.a, 1.0
...
test "#lighten", ->
  ...
  equalEnough color2.r, 45
  equalEnough color2.g, 64
  equalEnough color2.b, 39
  equalEnough color2.a, 1.0
