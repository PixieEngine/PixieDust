...
The `Flickerable` module provides a method to flicker a sprite between solid and a given opacity (alpha value). 
    ...
    # called with no arguments, flicker will toggle theplayer's alpha value between 0.9 (value provided above)
    # and 0.5 (flickerable default) every 0.1 second, lasting 2 seconds total
    player.flicker()
