Camera = (I={}) ->
  Object.reverseMerge I,
    ...
    transform: Matrix()
    scroll: Point(0, 0)
    maxVelocity: Point(Infinity, Infinity)
  ...
  focusOn = (object) ->
    ...
    if objectCenter.y > centerRect.bottom
      I.scroll.y = I.scroll.y.approach(centerRect.bottom, I.maxVelocity.y)
    else if objectCenter.y < centerRect.top
      I.scroll.y = I.scroll.y.approach(centerRect.top, I.maxVelocity.y)
